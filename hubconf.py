from maskclip.maskclip import tokenize as _tokenize, load as _load, available_models as _available_models
import re
import string

dependencies = ["torch", "torchvision", "ftfy", "regex", "tqdm", "pydensecrf"]
...
def _create_hub_entrypoint(model):
    ...
    entrypoint.__doc__ = f"""Loads the {model} MaskCLIP model
